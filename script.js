document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Current user:', window.gameConfig.currentUser);
    console.log('Current role:', window.gameConfig.currentRole);
    ...
    function gameFinished() {
        ...
        saveScore(window.gameConfig.currentUser, score);  // Enregistrer le score dans la base de données
    }
